                    ...
                    <div class="js-slick-carousel u-slick"
                        ...
                        <div class="js-slide">
                            <div class="hero row min-height-588 align-items-center">
                                ...
                                data-scs-animation-delay="500">
                                    <img class="img-fluid" src="/assets/img/Paperback.png" alt="image-description">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="js-slide">
                            <div class="hero row min-height-588 align-items-center">
                                ...
                                data-scs-animation-in="fadeInRight"
                                data-scs-animation-delay="500">
                                    <img class="img-fluid" src="assets/img/Kindle_Edition_2.jpg" alt="image-description">
                                </div>
                            </div>
                        </div>
                ...
                <div class="js-slick-carousel products no-gutters border-top border-left border-right"
                        ...
                        <div class="product__inner overflow-hidden p-3 p-md-4d875">
                            <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                                <div class="woocommerce-loop-product__thumbnail">
                                    <a href="../shop/single-product-v1.html" class="d-block"><img src="/assets/img/Paperback_2.png" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
                                </div>
                    ...
                    <div class="product">
                        <div class="product__inner overflow-hidden p-3 p-md-4d875">
                            <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                                <div class="woocommerce-loop-product__thumbnail">
                                    <a href="../shop/single-product-v1.html" class="d-block"><img src="assets/img/Kindle_Edition_2.jpg" class="img-fluid d-block mx-auto attachment-shop_catalog size-shop_catalog wp-post-image img-fluid" alt="image-description"></a>
                                </div>
                                <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                ...
                <ul class="row rows-cols-5 no-gutters authors list-unstyled js-slick-carousel u-slick"
                    ...
                    <li class="author col">
                        <a href="../others/authors-single.html" class="text-reset">
                            <img src="/assets/img/author_2.png" class="mx-auto mb-5 d-block rounded-circle" alt="image-description">
                    ...
                    <li class="author col">
                        <a href="../others/authors-single.html" class="text-reset">
                            <img src="assets/img/author.png" class="mx-auto mb-5 d-block rounded-circle" alt="image-description">
                            <div class="author__body text-center">
